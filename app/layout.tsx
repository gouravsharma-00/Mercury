    ...
    return(
        <html lang='en'>
            <head>
                ...
                <link rel="icon" href="/favicon/favicon16x16.png" />

                {/* Open Graph / Social Media Meta Tags */}
                <meta property="og:title" content="mercury | AI Manager" />
                <meta property="og:description" 
                content="An AI-powered application that analyzes GitLab commits and generates intelligent reports directly in your repository." />
                <meta property="og:image" content="/favicon/favicon16x16.png" />
                ...
                content="An AI-powered application that analyzes GitLab commits and generates intelligent reports directly in your repository." />
                <meta name="twitter:image" content="/favicon/favicon96x96.png" />
